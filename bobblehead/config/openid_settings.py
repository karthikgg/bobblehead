...
if DEBUG and not LOCAL_TEST:
    ...
    RETURN_URL = 'http://localhost:8000/user_profile/login_udacity'
elif not DEBUG and LOCAL_TEST:
    REALM_URL = 'http://localhost:8080/'
    RETURN_URL = 'http://localhost:8080/user_profile/login_udacity'
else:
    REALM_URL = 'http://www.nanoprojects.org/'
    RETURN_URL = 'http://www.nanoprojects.org/user_profile/login_udacity'
